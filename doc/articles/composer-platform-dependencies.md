...
packages to define dependencies ([require](../doc/04-schema.md#require), [conflict](../doc/04-schema.md#conflict),
[provide](../doc/04-schema.md#provide), [replace](../doc/04-schema.md#replace)) on different aspects of the platform, like PHP,
...
overwritten for the purposes of dependency resolution with a [platform configuration](../doc/06-config.md#platform).
...
Starting with version 2.0, Composer makes [additional features](../doc/07-runtime.md) (besides registering the class autoloader) available to the application runtime environment.
