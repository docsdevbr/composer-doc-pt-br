...
- If you set the [COMPOSER_ALLOW_SUPERUSER](../doc/03-cli.md#composer-allow-superuser) environment
...
See the [COMPOSER_ALLOW_SUPERUSER](../doc/03-cli.md#composer-allow-superuser) environment variable for
