...
- If you set the [COMPOSER_ALLOW_SUPERUSER](../03-cli#composer-allow-superuser) environment
...
See the [COMPOSER_ALLOW_SUPERUSER](../03-cli#composer-allow-superuser) environment variable for
