...
- If you set the [COMPOSER_ALLOW_SUPERUSER](../livro/cli.md#composer-allow-superuser) environment
...
See the [COMPOSER_ALLOW_SUPERUSER](../livro/cli.md#composer-allow-superuser) environment variable for
